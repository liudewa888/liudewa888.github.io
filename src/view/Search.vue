<template>
    ...
    weather city // 城市天气
      ...
      <h2>stackoverflow</h2>
      <p><a href="https://stackoverflow.com/help/searching">官方搜索文档</a></p>
      <h3>搜索语法</h3>
      <pre><code class="javascript language-javascript">
    [tag] // tag 搜索
    ...
    isaccepted:yes // status
      ...
      <h2>GitHub</h2>
      <p><a href="https://docs.github.com/cn/search-github/searching-on-github/searching-for-repositories">官方搜索文档</a>
      </p>
      <h3>搜索语法</h3>
      <pre><code class="javascript language-javascript">
